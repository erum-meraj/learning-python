def display_table(userid):
    ...
    button_pass_entry = tk.Button(frame, text="Add new password", font=('Bookman Old Style', 14), bg='#ffffff', fg="black" , command=lambda: pass_entry(userid))
    button_pass_entry.place(x=140,y=510, height=35, width= 200)
    table()
